        ...
        <div class="center mt-5">
            <div class="card m-5">
                <div class="card body">
                    ...
                    <h2 class="mt-3">Global Tongue Website</h2>
                    <div class="text-center">
                        <span class="badge badge-info">Laravel 9</span>
                    </div>
                    <hr>
                    <p>API Documentation for Basic Global Tongue Website</p>
                    <div class="card card-body m-2">
                        <div class="row">
                            <div class="col-5">
                                <h4>Features Added Yet:</h4>
                            </div>
                            <div class="col-7">
                    ...
                    <p class="text-center">
                        <a style="background-color:#333;" href="{{ route('l5-swagger.default.api') }}" class="btn btn-primary">
                            <i class="fa fa-book"></i> Read API Documentation
                        </a>
                        <a style="background-color:#333;" href="https://github.com/gemechis-elias/global-tongue" target="_blank"
                            class="btn btn-info">
